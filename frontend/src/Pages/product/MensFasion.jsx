...
const MensFasion = () => {
  ...
  useEffect(() => {
    if (location || products.length === 0) {
      const category = searchParams.getAll("product_category");
      const brand = searchParams.getAll("product_brand");
      //  const page = searchParams.getAll("page")
      const queryParams = {
        params: {
          category: category,
          brand: brand,
          sortBy: searchParams.get("sortBy") && "product_price",
          order: searchParams.get("sortBy"),
          page: page,
          limit: 10,
        },
      };
